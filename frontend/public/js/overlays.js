...
const addDataToShowOverlay = (data) => {
    ...
    department =
        document.querySelector("#show-overlay").childNodes[1].children[4];
    if (data.department) {
    ...
    speciality =
        document.querySelector("#show-overlay").childNodes[1].children[2];
...
const addDataToEditOverlay = (data) => {
    ...
    department =
        document.querySelector("#edit-overlay").childNodes[1].children[5];
    ...
    qualification =
        document.querySelector("#edit-overlay").childNodes[1].children[2];
    qualification.children[1].children[0].value = data.qualification.join(", ");

    speciality =
        document.querySelector("#edit-overlay").childNodes[1].children[3];
...
const submitEditRecord = () => {
    ...
    var providerID =
        document.querySelector("#edit-overlay").childNodes[1].children[0]
            .children[0].id;
    var name =
        document.querySelector("#edit-overlay").childNodes[1].children[1]
            .children[1].children[0].value;
    var department =
        document.querySelector("#edit-overlay").childNodes[1].children[5]
            .children[1].children[0].value;
    var organization =
        document.querySelector("#edit-overlay").childNodes[1].children[6]
            .children[1].children[0].value;
    var location =
        document.querySelector("#edit-overlay").childNodes[1].children[7]
            .children[1].children[0].value;
    var address =
        document.querySelector("#edit-overlay").childNodes[1].children[8]
            .children[1].children[0].value;
    var qualification =
        document.querySelector("#edit-overlay").childNodes[1].children[2]
            .children[1].children[0].value;
    var speciality =
        document.querySelector("#edit-overlay").childNodes[1].children[3]
            .children[1].children[0].value;
    var phone =
        document.querySelector("#edit-overlay").childNodes[1].children[4]
            .children[1].children[0].value;
...
const submitCreateRecord = () => {
    // TODO: Check for null values
    var name =
        document.querySelector("#create-overlay").childNodes[1].children[1]
            .children[1].children[0].value;
    var department =
        document.querySelector("#create-overlay").childNodes[1].children[5]
            .children[1].children[0].value;
    var organization =
        document.querySelector("#create-overlay").childNodes[1].children[6]
            .children[1].children[0].value;
    var location =
        document.querySelector("#create-overlay").childNodes[1].children[7]
            .children[1].children[0].value;
    var address =
        document.querySelector("#create-overlay").childNodes[1].children[8]
            .children[1].children[0].value;
    var qualification =
        document.querySelector("#create-overlay").childNodes[1].children[2]
            .children[1].children[0].value;
    var speciality =
        document.querySelector("#create-overlay").childNodes[1].children[3]
            .children[1].children[0].value;
    var phone =
        document.querySelector("#create-overlay").childNodes[1].children[4]
            .children[1].children[0].value;
